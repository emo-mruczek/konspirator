...
impl Compiler {
    pub fn if_handle_equal(
        ...
        res.push(SUB { pos: B });
        res.push(JPOS {
            pos: (block_instructions.len() as i64) + 5,
            adjust: true,
        });
        res.push(SWP { pos: B });
        res.push(SUB { pos: C });
        ...
        res.push(JUMP {
            pos: (else_block_instructions.len() as i64) + 1,
            adjust: true,
        });
    ...
    pub fn if_handle_notequal(
        ...
        res.push(SUB { pos: B });
        res.push(JPOS {
            pos: (else_block_instructions.len() as i64) + 5,
            adjust: true,
        });
        res.push(SWP { pos: B });
        res.push(SUB { pos: C });
        res.push(JPOS {
            pos: (else_block_instructions.len() as i64) + 2,
            adjust: true,
        });
        ...
        res.push(JUMP {
            pos: (block_instructions.len() as i64) + 1,
            adjust: true,
        });
        res.extend(block_instructions.clone());
