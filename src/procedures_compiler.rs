...
impl ProcedureCompiler {
    ...
    pub fn new(procedure: Procedure) -> Self {
        let renamed_commands =  Self::rename_commands(&procedure.commands, &procedure.proc_head.name.name);
        ...
        for command in commands {
            ...
            match command {
                ...
                If {cond, comm, else_comm} => {
                    ...
                    match else_comm {
                        Some(else_comm) =>  renamed_else_commands = Some(Self::rename_commands(else_comm, proc_name)),
